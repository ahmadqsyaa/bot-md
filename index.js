...
async function startNaze() {
    ...
    naze.sendMessage(callerId, { text: `tidak bisa mengangkat tlpn, chat saja..`}, { quoted : pa7rick })
    await sleep(8000)
    }
    })
    ...
    naze.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'ALL MENU' }, type: 1 },{ buttonId: 'menu', buttonText: { displayText: 'ALL MENU LIST' }, type: 1 }]
                let nyoutube = ('© rick')
